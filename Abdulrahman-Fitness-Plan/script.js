...
function updateWeightDisplay() {
    ...
    document.getElementById('startingWeight').textContent = memberConfig.startingWeight.toFixed(1) + ' kg';
    ...
    if (weightHistory.length > 0) {
        ...
        document.getElementById('currentWeight').textContent = memberConfig.startingWeight.toFixed(1) + ' kg';
    }
}
...
function applyMemberConfig() {
    ...
    if (longTermTargetEl) {
        longTermTargetEl.textContent = memberConfig.longTermTarget.toFixed(1) + ' kg';
    }
